  ...
  useEffect(() => {
    const fetchPendingOrders = async () => {
        ...
        try {
            ...
            console.log("Fetching orders for client ID:", clienteId);

            // Realiza la solicitud a la API para obtener órdenes del cliente específico
            const response = await axios.get(`${API_URL}/ordenes`, {
                params: {
                    id_cliente: clienteId,  // Usa el id_cliente obtenido
            ...
            const orders = response.data.data || []; // Asegúrate de que 'data' contenga las órdenes del cliente
                ...
                <Col lg={12}>
                    <Card>
                        <CardBody>
                            ...
                            {error ? (
                                <Alert color="danger">{error}</Alert> // Muestra el error aquí
